...
questions = {
    "1": {
        ...
        "candidates": [[5, 8, 9], [8, 9], [], [1, 2, 4, 8, 9], [1, 2, 4, 8, 9], [8, 9], [4, 5, 6, 8, 9],
                       [3, 4, 6, 8, 9], [3, 5, 8, 9]],
        "format": (3, 3),
    },
    "4": {
    ...
    "5": {
        ...
        "candidates": [[], [3, 7, 8], [3, 7], [2, 3, 4, 7, 8], [2, 7, 8], [2, 3, 4, 7, 8], [],
                       [], [], [], [], [], [3, 7], [], [], [], [3, 7], [], [3, 7, 8], [], [], [], [7, 8], [], [], [],
                       [3, 7],
                       [3, 5, 7], [3, 7], [], [], [], [2, 7], [], [2, 5], [], [5, 7], [], [], [2, 7, 8, 9], [],
                       [2, 7, 8],
                       [3, 7, 9], [2, 5], [3, 7], [], [], [], [7, 9], [], [], [], [7, 9], [], [3, 7, 8], [], [3, 7], [],
                       [2, 7, 8, 9],
                       [2, 3, 7, 8], [3, 7, 9], [], [], [], [3, 7, 8], [], [3, 7, 8], [], [], [], [3, 7, 8], [], [], [],
                       [], [3, 4, 7, 8],
    ...
    "6": {
        ...
        "candidates": [[1, 4], [1, 3, 7], [1, 3, 4, 7], [1, 2, 4, 5, 6, 7, 8], [1, 3, 4, 7, 8], [1, 2, 4, 5, 6, 8], [],
                       [1, 2, 3, 4, 6, 8], [1, 3, 4]],
        "format": (1, 9),
    },
}
...
def answer_part2(id):
    ...
    return render_template('quiz_part2_answer.html', id=id, solution1=solution1, solution2=solution2, question=question,
                           answer=answer, progress_bar=progressBar, is_correct=is_correct)
